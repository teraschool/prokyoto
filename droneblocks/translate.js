...
Blockly.Blocks['land_then_takeoff'] = {
  ...
  init: function() {
    this.jsonInit(
      {
        "message0": "数秒間着陸してからもう一度離陸 (land for %1 seconds then takeoff)",
        "args0": [
          {
              "type": "input_value",
              "name": "duration"
...
Blockly.Blocks['set_speed'] = {
  init: function() {
    this.jsonInit(
      {
        "message0": "スピード設定 (set speed to %1 %2)",
        "args0": [
          {
            "type": "input_value",
            "name": "speed"
...
Blockly.Blocks['curve'] = {
  init: function() {
    this.jsonInit(
      {
        "message0": "カーブ (curve x1 %1 y1 %2 z1 %3 x2 %4 y2 %5 z2 %6 %7)",
        "args0": [
          {
            "type": "input_value",
            "name": "x1distance"
...
Blockly.Blocks['yaw_right'] = {
  init: function() {
    this.jsonInit(
      {
        "message0": "右に向きを変える (yaw right %1 度)",
        "args0": [
          {
            "type": "input_value",
            "name": "angle"
...
Blockly.Blocks['yaw_left'] = {
  init: function() {
    this.jsonInit(
      {
        "message0": "左に向きを変える (yaw left %1 度)",
        "args0": [
          {
            "type": "input_value",
            "name": "angle"
